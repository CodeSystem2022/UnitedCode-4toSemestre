...
//puede modificar el valor de la variable salir, si es verdadero termina el ciclo while
    private static boolean ejecutarOpciones(Scanner consola, EstudianteDAO estudianteDao) {
        ...
        switch (opcion) {
            ...
            case 2 -> { //Buscar estudiantes por ir
                System.out.println("Introduce el id_estudiantes a buscar: ");
                var idEstudiante = integer.parseInt(consola.nextLine());
                var estudiante = new Estudiante(idEstudiante);
                var encontrado = estudianteDao.buscarEstudianteParId(estudiante);
                if (encontrado)
            ...
            case 4 -> { //Modificar estudiantes
                ...
                System.out.println("Id Estudiantes: ");
                var idEstudiante = Integer.parseInt(consola.nextLine());
                System.out.println("Nombre: ");
                var nombre = consola.nextLine();
                System.out.println("Apellido: ");
